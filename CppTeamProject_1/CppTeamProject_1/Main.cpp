...
void Render(vector<char> _map[MAP_HEIGHT][MAP_WIDTH], PPLAYER _pPlayer) {
	...
	cout << "»ýÁ¸ È®·ü: " << _pPlayer->surv_percentage << '%';
	Gotoxy(TIMER_POS.x, TIMER_POS.y + 5 + 3);		//Item Value Render
	cout << "¾ÆÀÌÅÛ °¡Ä¡: " << _pPlayer->value;
...
void ItemInit() {
	...
	obj_icon[OBJ_TYPE::SIT] = "¡á";
	obj_icon[OBJ_TYPE::SPEED] = "¢Í";
	obj_icon[OBJ_TYPE::MAGNET] = "¡ú";

	// ¹®ÀÚ
	obj_icon[OBJ_TYPE::MIRROR] = "¢Á";
	obj_icon[OBJ_TYPE::LONGCOAT] = "¡Ï";
	obj_icon[OBJ_TYPE::WATER] = "â©";
	obj_icon[OBJ_TYPE::FLASHLIGHT] = "¢Ó";
	obj_icon[OBJ_TYPE::PARACHUTE] = "¡Ò";
	obj_icon[OBJ_TYPE::KNIFE] = "4 ";
	obj_icon[OBJ_TYPE::RAINCOAT] = "¤ï";
	obj_icon[OBJ_TYPE::PISTOL] = "¦Á ";
	obj_icon[OBJ_TYPE::SUNGLASS] = "¡Ä";
	obj_icon[OBJ_TYPE::BANDAID] = "«í";
	obj_icon[OBJ_TYPE::AXE] = "£Ð";
	obj_icon[OBJ_TYPE::GOLDRING] = "¨Ó";
	obj_icon[OBJ_TYPE::SILVERRING] = "¨ß";
	obj_icon[OBJ_TYPE::MACBOOK] = "¤Þ";
	obj_icon[OBJ_TYPE::IPHONE] = "¢Î";
	obj_icon[OBJ_TYPE::AIRPODS] = "¢Ý";
	obj_icon[OBJ_TYPE::MAX] = "§Ù";
	obj_icon[OBJ_TYPE::IPAD] = "¢³";
	obj_icon[OBJ_TYPE::CHANDELIER] = "¥×";
	obj_icon[OBJ_TYPE::TRASH] = "ªÒ";
	obj_icon[OBJ_TYPE::FILTHBAG] = "¥ä";
	obj_icon[OBJ_TYPE::BALLPEN] = "¢®";
	obj_icon[OBJ_TYPE::ERASER] = "£Ä";
	obj_icon[OBJ_TYPE::NOTEPAD] = "¡Õ";
	obj_icon[OBJ_TYPE::KEYBOARD] = "¢Ë";
	obj_icon[OBJ_TYPE::BOOK] = "¡ô";
	obj_icon[OBJ_TYPE::GLASSES] = "¤õ";
	obj_icon[OBJ_TYPE::TISSUE] = "¢Ç";
	...
	synergy_vec.push_back(SYNERGY("¿À¹°", 24, { OBJ_TYPE::TRASH,OBJ_TYPE::FILTHBAG,OBJ_TYPE::TISSUE }, COLOR::VOILET));
	synergy_vec.push_back(SYNERGY("¸ðÇèÀÚ", 12, { OBJ_TYPE::MIRROR, OBJ_TYPE::WATER, OBJ_TYPE::FLASHLIGHT, OBJ_TYPE::KNIFE }, COLOR::RED));
	synergy_vec.push_back(SYNERGY("¸Æ°¡ÀÌ¹ö", 9, { OBJ_TYPE::KNIFE, OBJ_TYPE::AXE }, COLOR::BLUE));
	synergy_vec.push_back(SYNERGY("¸ÚÀïÀÌ", 15, { OBJ_TYPE::SUNGLASS, OBJ_TYPE::LONGCOAT, OBJ_TYPE::MIRROR }, COLOR::YELLOW));
	synergy_vec.push_back(SYNERGY("»ê½Å·É", 24, { OBJ_TYPE::AXE, OBJ_TYPE::GOLDRING, OBJ_TYPE::SILVERRING }, COLOR::LIGHT_GREEN));
	synergy_vec.push_back(SYNERGY("¾ÛµîÀÌ", 50, { OBJ_TYPE::MACBOOK, OBJ_TYPE::IPHONE, OBJ_TYPE::AIRPODS, OBJ_TYPE::IPAD, OBJ_TYPE::MAX }, COLOR::MINT));
	synergy_vec.push_back(SYNERGY("È«»óÈ­", 10, { OBJ_TYPE::GLASSES, OBJ_TYPE::KEYBOARD }, COLOR::GREEN));
	synergy_vec.push_back(SYNERGY("ÀÌÇÑº°", 10, { OBJ_TYPE::GLASSES, OBJ_TYPE::IPHONE, OBJ_TYPE::AIRPODS }, COLOR::SKYBLUE));
