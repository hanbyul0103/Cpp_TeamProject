...
void ItemInit() {
	...
	synergy_vec.push_back({ "¿À¹°",24,{OBJ_TYPE::TRASH,OBJ_TYPE::FILTHBAG,OBJ_TYPE::TISSUE} });
	synergy_vec.push_back({ "¸ðÇèÀÚ" ,12,{OBJ_TYPE::MIRROR, OBJ_TYPE::WATER, OBJ_TYPE::FLASHLIGHT, OBJ_TYPE::KNIFE} });
	synergy_vec.push_back({ "¸Æ°¡ÀÌ¹ö",9,{OBJ_TYPE::KNIFE, OBJ_TYPE::AXE} });
	synergy_vec.push_back({ "¸ÚÀïÀÌ",15,{OBJ_TYPE::SUNGLASS, OBJ_TYPE::LONGCOAT, OBJ_TYPE::MIRROR } });
	synergy_vec.push_back({ "»ê½Å·É",24,{OBJ_TYPE::AXE, OBJ_TYPE::GOLDRING, OBJ_TYPE::SILVERRING} });
	synergy_vec.push_back({ "¾ÛµîÀÌ",50,{OBJ_TYPE::MACBOOK, OBJ_TYPE::IPHONE, OBJ_TYPE::AIRPODS, OBJ_TYPE::IPAD, OBJ_TYPE::MAX} });
	synergy_vec.push_back({ "È«»óÈ­",10,{OBJ_TYPE::GLASSES, OBJ_TYPE::KEYBOARD} });
	synergy_vec.push_back({ "ÀÌÇÑº°",10,{OBJ_TYPE::GLASSES, OBJ_TYPE::IPHONE, OBJ_TYPE::AIRPODS} });
